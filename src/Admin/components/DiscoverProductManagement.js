...
import { FaPlus, FaSearch, FaEye, FaEdit, FaTrash, FaChevronLeft, FaChevronRight } from 'react-icons/fa'; // Importing necessary icons from react-icons/fa
...
export function DiscoverProductManagement() {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm font-sans max-w-7xl mx-auto ">
      <div className="flex justify-end items-center mb-6 flex-wrap gap-4">
        <Link to="/admin/addProduct" className="no-underline flex items-center px-5 py-2 bg-[rgb(4,120,87)] text-white rounded-lg text-base font-medium hover:bg-green-700 transition-colors shadow-md">
          <FaPlus className="w-5 h-5 mr-2" /> {/* Replaced SVG with FaPlus */}
          Add New Product
        </Link>
      </div>
      ...
      <div className="relative mb-8">
        ...
        />
        <FaSearch className="h-5 w-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" /> {/* Replaced SVG with FaSearch */}
      </div>
      ...
      <div className="mb-10">
        ...
        <div className="flex justify-between items-center flex-wrap gap-3 py-3">
          ...
          >
            <FaChevronLeft className="h-4 w-4 mr-1" /> {/* Replaced SVG with FaChevronLeft */}
            Previous
          </button>
          ...
          >
            Next
            <FaChevronRight className="h-4 w-4 ml-1" /> {/* Replaced SVG with FaChevronRight */}
          </button>
        </div>
      </div>
