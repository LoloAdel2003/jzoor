        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm text-center">
            ...
            <p className="text-sm text-gray-600 mb-2 flex items-center justify-center">
              ...
              <HiOutlineEnvelope className="w-4 h-4 ml-2 text-gray-400" />
            </p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="flex justify-between items-center mb-6">
              ...
              <button className="flex items-center text-gray-500 hover:text-gray-700">
                <HiOutlinePencilSquare className="w-5 h-5 mr-1" />
                Edit
              </button>
            </div>
              ...
              <div>
                ...
                <div className="relative mt-1 rounded-md shadow-sm">
                  ...
                  <div className="absolute inset-y-0 right-0 flex items-center pr-2">
                    ...
                    <HiOutlineChevronDown className="w-4 h-4 ml-1 text-gray-400" />
                  </div>
                </div>
              </div>
              <div>
            ...
            {/* Save Profile Changes Button (added for completeness) */}
