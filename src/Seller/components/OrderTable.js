...
export function OrderTable() {
  ...
  const orders = [
    { no: 1, orderId: '#ORD0001', product: 'Asphodel', date: '01-01-2025', price: '49.99', status: 'Pending' },
    { no: 2, orderId: '#ORD0002', product: 'Olive Tree', date: '01-01-2025', price: '49.99', status: 'Delivered' },
    { no: 3, orderId: '#ORD0003', product: 'Mint', date: '01-01-2025', price: '49.99', status: 'Preparing' },
    { no: 4, orderId: '#ORD0004', product: 'Loquat', date: '01-01-2025', price: '49.99', status: 'Shipped' },
    { no: 5, orderId: '#ORD0005', product: 'Marigold', date: '01-01-2025', price: '49.99', status: 'Delivered' },
      ];
