...
export function UserProfilePage() {
  ...
  return (
    <div className="bg-[#f3f4f6] min-h-screen font-sans p-4"> {/* Added padding for overall layout */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm text-center">
            ...
            <img
              src="/imges/seller.webp" // Placeholder image for profile picture
              alt="Ahmad Kanaan"
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="flex items-center mb-6">
              <img
                src="/imges/seller.webp" // Placeholder for profile picture update
                alt="Profile"
